...
Usage:
  ...
  # Create test data:
  python generate_tfrecord.py --csv_input=test.csv  --output_path=test.record
"""
...
def class_text_to_int(row_label):
    return int(row_label.split('-')[-1])+1
# def class_text_to_int(row_label):
#     if row_label == 'Pepper':
#         return 1
#     elif row_label == 'Jello':
#         return 2
#     elif row_label == 'Orange_Juice':
#         return 3
#     elif row_label == 'Penguin':
#         return 4
#     elif row_label == 'Espresso':
#         return 5
